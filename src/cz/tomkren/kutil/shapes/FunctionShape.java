...
public class FunctionShape extends ConvexPolygonShape {
    ...
    private Color bodyColor = new Color(253,253,254);
    public static final Color DEFAULT_bodyColor = new Color(253,253,254);

    public FunctionShape(int numInputs, int numOutputs, String name, List<AB<String,Integer>> targets, List<Double> weights, Color bodyColor, Kutil kutil) {
        ...
        this.bodyColor = bodyColor == null ? DEFAULT_bodyColor : bodyColor;
        this.kutil = kutil;
                    ...
                    if (target != null) {
                        ...
                        if (targetDrawPos != null) {
                            ...
                            if (weights != null) {
                                ...
                                Double w = weights.get(localOutputPort);

                                if (w != null) {

                                    int str_x = (x + targetDrawPos.getX()) / 2;
                                    int str_y = ((e_y + 1) + targetDrawPos.getY()) / 2;

                                    g.setFont(font);
                                    g.setColor(Color.black);
                                    g.drawString(w.toString(), xZoomIt(str_x), yZoomIt(str_y));
                                }
