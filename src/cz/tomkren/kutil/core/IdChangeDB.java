...
public class IdChangeDB {
    ...
    public IdChangeDB() {tab = new HashMap<String, String>();}
     ...
     * @param newId nové id
     */
    public void put( String oldId , String newId ){tab.put(oldId, newId);}

    /** Vyčistí databázi pro další použití. */
    public void clear(){tab.clear();}

    /**
     * Opraví předložený targetString na základě hodnot uložených v databázi.
    ...
    public String toString() {
        ...
        for (Entry<String, String> ent : tab.entrySet()) {
